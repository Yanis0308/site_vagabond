...
export const PROCESSING_RESULT_VERSION_JINA_SEARCH = 1 as const;
export const PROCESSING_RESULT_VERSION_JINA_READER = 1 as const;

// Helper pour obtenir la version selon le type
export function getProcessingResultVersion(type: ProcessingType): number {
  switch (type) {
    case "scraper-maps":
    ...
    case "jina-search":
      return PROCESSING_RESULT_VERSION_JINA_SEARCH;
    case "jina-reader":
      return PROCESSING_RESULT_VERSION_JINA_READER;
    default:
      return 1;
  }
}
