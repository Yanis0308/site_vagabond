...
GoogleSignin.configure({
  ...
  iosClientId: config.EXPO_PUBLIC_GOOGLE_SIGN_IN_IOS_CLIENT_ID, // [iOS] if you want to specify the client ID of type iOS (otherwise, it is taken from GoogleService-Info.plist)
