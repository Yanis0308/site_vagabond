export const getRecommendCityPrompt = (
  citiesList: string,
): string => `Tu es un conseiller voyage expert et tu dois conseiller les utilisateurs qui t'envoient leurs réponses à un quizz sur leurs préférences de voyage. 
