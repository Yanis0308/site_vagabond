        ...
        <div className="text-center">
          ...
          <div className="mx-auto flex max-w-xs flex-col items-center gap-4">
            <a
              ...
              className="group flex w-full items-center justify-center gap-3 text-gray-600 transition-colors hover:text-primary"
            >
              <svg
              ...
              <span className="min-w-[100px] text-left text-lg font-medium group-hover:text-primary">
                {t("social.instagram")}
              </span>
            </a>
            <a
