...
const selectTriggerStyle = tva({
  base: "border border-background-300 bg-background-100 rounded flex-row items-center overflow-hidden data-[hover=true]:border-outline-400 data-[focus=true]:border-primary-700 data-[disabled=true]:opacity-40 data-[disabled=true]:data-[hover=true]:border-background-300",
  variants: {
    size: {
      xl: "min-h-12",
      lg: "min-h-11",
