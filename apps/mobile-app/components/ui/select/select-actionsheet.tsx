...
const actionsheetContentStyle = tva({
  base: "items-center rounded-tl-3xl rounded-tr-3xl p-2 bg-background-50 web:pointer-events-auto web:select-none shadow-lg pb-safe",
});
...
const actionsheetBackdropStyle = tva({
  base: "absolute left-0 top-0 right-0 bottom-0 bg-background-900 web:cursor-default web:pointer-events-auto",
});
...
>(function ActionsheetVirtualizedList({ className, ...props }, ref) {
  return (
    // @ts-expect-error - from gluestack-ui
