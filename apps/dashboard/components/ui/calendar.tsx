...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        `
          group/calendar bg-background p-3 [--cell-radius:var(--radius-md)] [--cell-size:--spacing(6)]
...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      className={cn(
        `
          relative isolate z-10 flex aspect-square size-auto w-full min-w-(--cell-size) flex-col gap-1 border-0
