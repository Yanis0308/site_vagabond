    ...
    props: mergeProps<"div">(
      {
        className: cn(
          `
            flex h-8 shrink-0 items-center rounded-md px-2 text-xs text-sidebar-foreground/70 ring-sidebar-ring
...
const sidebarMenuButtonVariants = cva(
  `
    ...
    rounded-[calc(var(--radius-sm)+2px)] p-2 text-left text-xs ring-sidebar-ring outline-hidden
    ...
    variants: {
      variant: {
        ...
        outline: `
          ...
          hover:bg-sidebar-accent hover:text-sidebar-accent-foreground hover:shadow-[0_0_0_1px_var(--sidebar-accent)]
        `,
      },
      size: {
        default: "h-8 text-xs",
    ...
    props: mergeProps<"button">(
      {
        className: cn(
          `
            ...
            rounded-[calc(var(--radius-sm)-2px)] p-0 text-sidebar-foreground ring-sidebar-ring outline-hidden
    ...
    <div
      ...
      className={cn(
        `
          ...
          rounded-[calc(var(--radius-sm)-2px)] px-1 text-xs font-medium text-sidebar-foreground tabular-nums select-none
          group-data-[collapsible=icon]:hidden
          peer-hover/menu-button:text-sidebar-accent-foreground
          peer-data-[size=default]/menu-button:top-1.5
          peer-data-[size=lg]/menu-button:top-2.5
