...
const pbfPath = path.join(
  process.cwd(),
  "src/etl/pbf-files/osm-france-10-02-2025.pbf",
);
...
const luaFilePath = path.join(process.cwd(), "src/etl/import-pois.lua");
...
const params = [
  ...
  // "--slim", // use database instead of RAM, needed for append mode (update)
  "--create",
